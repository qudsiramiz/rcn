...
def seaborn_subplots(
    ...
    if fig_name is None:
        fig_name = f"../figures/seaborn_plots/{keys[0]}_vs_{keys[1]}_dm_{dark_mode}_20221027.{fig_format}"
    else:
        fig_name = f"../figures/seaborn_plots/20221027/{fig_name}_{dark_mode}_20221027.{fig_format}"
