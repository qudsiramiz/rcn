...
def plot_hist(file_name, dark_mode=True, nbins=8, fig_folder="../figures", fig_name="new",
              fig_format="pdf"):
...
for file_name in fnames:
    ...
    fig_folder = f"../figures/rx_hist/"
    fig_name = f"rx_hist_{mms_probe_num}"
    fig_format = 'pdf'
    plot_hist(file_name, dark_mode=True, nbins=8, fig_folder=fig_folder, fig_name=fig_name,
