...
df_crossings = pd.read_csv("../data/event_list_MMS_jet_reversals_from_steve.csv", index_col=False)
# df_jet_reversal_times = pd.read_csv("../data/mms_jet_reversal_times_list_20221017_beta.csv",
#                                    index_col=False)
# Set the index to the date column
df_crossings.set_index("jet_time", inplace=True)
...
def check_jet_reversal(crossing_time):
    ...
    crossing_time = datetime.datetime.strptime(crossing_time, "%Y-%m-%d %H:%M:%S")
    ...
    inputs = {'crossing_time': crossing_time,
              ...
              'fname': f'../data/mms_jet_reversal_times_list_{date_obs}_steve_brst.csv',
              # 'fname': '../data/test.csv',
              'error_file_log_name': f"../data/mms_jet_reversal_check_err_log_{date_obs}_steve.csv",
              "verbose": True
              }
